/****************************************************************************
 *
 * $Id: vpTb.h 4056 2013-01-05 13:04:42Z fspindle $
 *
...
/*!
  ...
  \f].
*/
class VISP_EXPORT vpTb: public vpUnicycle
{
public:
  /*!
...
private:
  ...
  void set_cMe()
  {
    ...
    double l = -0.0; // distance between the camera frame and the mobile robot frame
    vpTranslationVector cte; // meters
    vpRxyzVector        cre; // radian
    //cte.set(0, 0, -l);
    cte.set(0, 0, 0);

    cre.buildFrom(vpMath::rad(80.), 0, vpMath::rad(80.));
